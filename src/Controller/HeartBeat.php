...
/**
 * Actions that keep a session active. Intended to be called by javascript while someone is on a page
 * @package SLOCloud\Controller
 */
class HeartBeat extends Base
{
    ...
    {
        $app = $this->app;
        $app->session('lastBeat', new \DateTime());
    }
}
