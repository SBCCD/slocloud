...
*/
namespace SLOCloud\Model\Storage\Mapping;

use Doctrine\DBAL\Platforms\SQLServer2008Platform;

class CustomSQLServer2008Platform extends SQLServer2008Platform
{
    /**
     * {@inheritDoc}
     *
     * set Clob to NVARCHAR(MAX) so text is NVARCHAR(MAX) instead of VARCHAR(MAX)
     */
     ...
     * {@inheritDoc}
     *
     * Normal truncate won't work if the table has foreign key constraints.
     * Instead, delete all and reset identity seed
     */
