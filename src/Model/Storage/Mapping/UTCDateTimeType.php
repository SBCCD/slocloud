...
/**
 * Custom type that always writes and reads UTC times
 * From Doctrine 2 Docs
 * @package SLOCloud\Model\Storage\Mapping
 */
class UTCDateTimeType extends DateTimeType
{
    ...
    public function convertToPHPValue($value, AbstractPlatform $platform)
    {
        ...
        if (!$val) {
            $val = new \DateTime($value, (self::$utc) ? self::$utc : (self::$utc = new \DateTimeZone('UTC')));
        }
        if (!$val) {
