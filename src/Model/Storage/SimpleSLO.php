...
class SimpleSLO extends SLO
{
    ...
    public function getPloArray()
    {
        return explode('|', parent::getPlos());
    }

    public function getGeoArray()
    {
        return explode('|', parent::getGeos());
    }

    public function getIloArray()
    {
        return explode('|', parent::getIlos());
    }
    ...
    public function jsonSerialize()
    {
        return [
            ...
            'plos' => $this->getPloArray(),
            'geos' => $this->getGeoArray(),
            'ilos' => $this->getIloArray(),
