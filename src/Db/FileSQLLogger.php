...
class FileSQLLogger implements SQLLogger
{
    ...
    public function startQuery($sql, array $params = null, array $types = null)
    {
        ...
        if ($params) {
            $output .= ", ['".$this->join("', '", $params)."']";
        }

        if ($types) {
            $output .= ", ['".$this->join("', '", $types)."']";
        }
     ...
     * @return string
     */
    private function join($glue, array $array)
    {

        return join($glue, array_map(function ($value) use ($glue) {
