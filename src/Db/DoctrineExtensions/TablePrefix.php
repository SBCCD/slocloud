...
*/
namespace SLOCloud\Db\DoctrineExtensions;

use Doctrine\ORM\Event\LoadClassMetadataEventArgs;
use Doctrine\ORM\Mapping\ClassMetadataInfo;

/**
 * Allows table prefixes. Based on
 * http://doctrine-orm.readthedocs.org/en/latest/cookbook/sql-table-prefixes.html
 * @package SLOCloud\Db\DoctrineExtensions
 */
class TablePrefix
{
    protected $prefix = '';
